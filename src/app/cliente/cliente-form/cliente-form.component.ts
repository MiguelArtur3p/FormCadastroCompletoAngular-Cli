...
export class ClienteFormComponent implements OnInit, OnDestroy, IFormCanDeactivate 
{
  ...
  async obterCidade(id: string) 
  {
    ...
    // let cidade = await this._cidadeService.obterCidadePorId(
    //   Number(target.value)
    // );
  ...
  openDialog() 
  {
    ...
    dialogRef.afterClosed().subscribe((result: any) => 
    {
      ...
      this.inputCodigoCidade.nativeElement.value = this.idCidadeSelecionada;
  ...
  async ngOnInit() 
  {
    this.inscricao = this._sharedService.idCidadeSelecionadaEmitter.subscribe(id => this.idCidadeSelecionada = id)
